...
<h4 class="center" style="color:blue;">Editar Utilizador Administração</h4> 
<div class="center">
<form action="{{route('edit-user')}}" class="form_gray" method="post">
    ...
    <button style="text-align:center;" class="btn btn-outline-success" type="submit" id="btn_blue">Guardar</button>
</form>
</div>
